...
const handleCloseSnackbar = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
        ...
        setSnackbarMessage('Loginda xato yuz berdi: ' + error.message);
  ...
  <Alert onClose={handleCloseSnackbar} severity={snackbarSeverity}>
    {snackbarMessage}
          ...
          <GoogleOAuthProvider clientId="8608879487-uhqltrablhvohm4nvdivvgifrn68ieqs.apps.googleusercontent.com">
              <GoogleLogin
